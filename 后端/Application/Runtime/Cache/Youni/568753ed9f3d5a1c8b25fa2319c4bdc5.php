	  ...
	  <div class="layui-form layui-card-header layuiadmin-card-header-auto" wid100="">
        <div class="layui-form-item">
          ...
          <div class="layui-inline">
		   <form action="/Youni/Kami/sou" method="POST">
          ...
          <div class="layui-inline">
		    <form action="/Youni/Kami/daotxt" method="POST">
        ...
        <div class="layui-card-body">
          ...
          <a class="layui-btn layuiadmin-btn-admin" href="/Youni/Kami/add">添加</a>
		  <a class="layui-btn layui-btn-warm" href="/Youni/Kami/txt">导出</a>
        </div>
	   ...
	   <span class="label label-success radius">未使用</span><?php endif; ?>
                       ...
                       <td class="td-manage">
                        ...
                        <a title="删除" href="/Youni/Kami/del?id=<?php echo ($vo["id"]); ?>"
