...
<body>
  ...
  <div class="layadmin-user-login layadmin-user-display-show" id="LAY-user-login" style="display: none;background:url(/Public/bbb.jpg) no-repeat;background-size:100% 100%;">
    ...
    <div class="layadmin-user-login-main">
	  ...
	  <form class="am-form" action="/Youni/Public/checkLogin/" method="POST">
          ...
          <div class="layui-row">
            ...
            <div class="layui-col-xs5">
              <div style="margin-left: 10px;">
                <img src="/Youni/Public/verifyImg" class="layadmin-user-login-codeimg" id="admin-login-get-vercode"  onclick="this.src='/Youni/Public/verifyImg/'+Math.random()">
              </div>
            </div>
          </div>
        </div>
