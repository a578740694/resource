...
<body>
	  ...
	  <div class="layui-form layui-card-header layuiadmin-card-header-auto" wid100="">
        <div class="layui-form-item">
          ...
          <div class="layui-inline">
		   <form action="/Youni/User/sea" method="POST">
		  ...
		  <div class="layui-inline">
            <button class="layui-btn layuiadmin-btn-admin" lay-submit="" lay-filter="card-table-list-search">
              <i class="layui-icon layui-icon-search layuiadmin-button-btn"></i>
				...
				<div class="layui-inline">
		   <form action="/Youni/User/sou" method="POST">
        ...
        <div class="layui-card-body">
          ...
          <a class="layui-btn layuiadmin-btn-admin" href="/Youni/User/add">添加</a>
 ...
 $time = time(); $vip = $vo['viptime']; if($vip < $time){ echo '<td class="am-hide-sm-only" style="color:red;">'.date('Y-m-d H:i:s',$vo['viptime']).'</td>'; }else{ echo '<td class="am-hide-sm-only">'.date('Y-m-d H:i:s',$vo['viptime']).'</td>'; } ?>
                        ...
                        <td class="td-manage">
							...
							<a class="layui-btn layui-btn-xs" lay-event="editPass"href="/Youni/User/editPass?id=<?php echo ($vo["id"]); ?>" title="编辑" style="margin-left: 0px;"><i class="layui-icon layui-icon-edit"></i>编辑</a>
                            
							<a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="closeAgent" data-type="0" href="/Youni/User/del?id=<?php echo ($vo["id"]); ?>"title="删除" style="margin-left: 0px;"><i class="layui-icon layui-icon-close"></i>删除</a>
							
							<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="recharge" title="充值" style="margin-left: 0px;" href="/Youni/User/money?id=<?php echo ($vo["id"]); ?>"><i class="layui-icon layui-icon-diamond" ></i>充值</a>
