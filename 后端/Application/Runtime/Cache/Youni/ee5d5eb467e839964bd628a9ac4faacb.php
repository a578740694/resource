    ...
    <div class="layui-col-md12">
      <div class="layui-card">
        <div class="layui-card-body">
          ...
          <a class="layui-btn layuiadmin-btn-admin" href="/Youni/Notice/add">添加</a>
        </div>
                ...
                <thead>
				 ...
				 <?php if(is_array($mod)): $i = 0; $__LIST__ = $mod;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody>
                    <tr>
                        ...
                        <td class="td-manage">
                            <!-- <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="recharge" title="弹窗" style="margin-left: 0px;" href="/Youni/Notice/tans?id=<?php echo ($vo["id"]); ?>"><i class="layui-icon layui-icon-diamond" ></i>弹窗</a> -->
                            <a class="layui-btn layui-btn-xs" lay-event="editPass"href="/Youni/Notice/edit?id=<?php echo ($vo["id"]); ?>" title="编辑" style="margin-left: 0px;"><i class="layui-icon layui-icon-edit"></i>编辑</a>
                            
                            <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="closeAgent" data-type="0" href="/Youni/Notice/del?id=<?php echo ($vo["id"]); ?>"title="删除" style="margin-left: 0px;"><i class="layui-icon layui-icon-close"></i>删除</a>
