                ...
                <div carousel-item="">
                  <ul class="layui-row layui-col-space10">
                      <li class="layui-col-xs3">
                        <a href="javascript:;" lay-href="/Youni/Config/add">
                          <i class="layui-icon layui-icon-set"></i>
                          <cite>设置</cite>
                        </a>
                      </li>
                       <li class="layui-col-xs3">
                        <a lay-href="/Youni/Notice/index">
                          <i class="layui-icon layui-icon-user"></i>
                          <cite>公告</cite>
                        </a>
                      </li>
					<li class="layui-col-xs3">
                        <a lay-href="/Youni/Kami/index">
                          <i class="layui-icon layui-icon-user"></i>
                          <cite>卡密</cite>
                        </a>
                      </li>
						<li class="layui-col-xs3">
                        <a lay-href="/Youni/Reso/index">
                          <i class="layui-icon layui-icon-user"></i>
                          <cite>资源</cite>
                        </a>
                      </li>
					  <li class="layui-col-xs3">
                        <a lay-href="/Youni/Adver/index">
                          <i class="layui-icon layui-icon-user"></i>
                          <cite>轮播</cite>
                        </a>
                      </li>
					   <li class="layui-col-xs3">
                        <a lay-href="/Youni/Type/index">
                          <i class="layui-icon layui-icon-user"></i>
                          <cite>分类</cite>
                        </a>
                      </li>
					   <li class="layui-col-xs3">
                        <a lay-href="/Youni/Link/index">
                          <i class="layui-icon layui-icon-user"></i>
                          <cite>更多</cite>
                        </a>
                      </li>
                      <li class="layui-col-xs3">
                        <a lay-href="/Youni/User/index">
                          <i class="layui-icon layui-icon-user"></i>
                          <cite>用户</cite>
                        </a>
                      </li>
